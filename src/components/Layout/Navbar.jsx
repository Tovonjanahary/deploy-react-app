    ...
    <nav className="flex items-center justify-between md:justify-center bg-white flex-wrap w-full p-6 sticky top-0 z-50">
      ...
      <div className="w-full block flex-grow lg:flex lg:items-center lg:w-auto md"> 
          <div className="text-sm flex flex-row items-center md:justify-center">
            ...
            <div className="flex items-end text-base text-gray-700">
              <DesignServicesIcon/>
              <Link to="/services" className="block mt-4 lg:inline-block lg:mt-0 mr-4 basis-1/2">
                Services
              </Link>
            </div>
            <div className="flex items-end text-base text-gray-700">
              <AddIcCallIcon/>
              <Link to='/contact' className="block mt-4 lg:inline-block lg:mt-0 mr-4 basis-1/2">
                Contact
              </Link>
            </div>
            {
              ...
              <div className="basis-1/2">
                <div className="relative basis-1/2 flex flex-row basis-1/2 items-center">
                  <img style={{ borderRadius: "50%" }} width="20px" height="20px" src={imgSrc} alt={userInfo.name} onClick={() => {setShowProfil(!showProfil)}} onError = {() => setImgSrc("/img/img.png")}/>
